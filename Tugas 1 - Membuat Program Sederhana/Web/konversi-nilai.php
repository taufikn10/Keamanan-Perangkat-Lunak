          ...
          <div class="mx-lg-5 py-5">
            <form method="POST" action="" enctype="multipart/form-data">
              ...
              <div class=" form-group">
                <div class="mb-3">
                  ...
                  <select name="matakuliah" class="form-control" required>
                    ...
                    <option value="Pengembangan Applikasi Permainan">Pengembangan Applikasi Permainan</option>
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="absen" placeholder="masukan nilai partisipasi"
                  value="<?=$absen?>" required onkeypress="return tAngka(event)">
              </div>

              <div class="mb-3">
                <label for="tugas" class="form-label">Nilai Tugas</label>
                <input class="form-control" type="text" name="tugas" placeholder="masukan nilai tugas"
                  value="<?=$tugas?>" required onkeypress="return tAngka(event)">
              </div>

              <div class="mb-3">
                <label for="uts" class="form-label">Nilai UTS</label>
                <input class="form-control" type="text" name="uts" placeholder="masukan nilai UTS" value="<?=$uts?>"
                  required onkeypress="return tAngka(event)">
              </div>

              <div class="mb-5">
                <label for="uas" class="form-label">Nilai UAS</label>
                <input class="form-control" type="text" name="uas" placeholder="masukan nilai UAS" value="<?=$uas?>"
                  required onkeypress="return tAngka(event)">
              </div>
              <div class="row">
                <div class="col-6">
