            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="panjang" placeholder="masukan panjang cm"
                  value="<?=$panjang?>" required onkeypress="return tAngka(event)" maxlength="15">
              </div>
              ...
              <div class="mb-3">
                ...
                <input class="form-control" type="text" name="tinggi" placeholder="masukan tinggi cm"
                  value="<?=$tinggi?>" required onkeypress='return tAngka(event)' maxlength="15">
              </div>
        ...
        <div class="card mb-5 col-lg-6 shadow-sm">
          <div class="mx-lg-5 py-5">
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-4">
                  <button class="btn btn-primary container" name="volume">Hitung
                    Volume</button>
                </div>
                <div class="col-4">
                  <button class="btn btn-danger container" name="reset" type="reset">Hapus</button>
